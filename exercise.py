...
for article in my_dictionary['response']['results']:
    # print(article)
    article['views'] = 0
    print(article)

def read_article():
    quantity_of_articles = len(my_dictionary['response']['results'])
    # print(quantity_of_articles)
    random_number = random.randint(1, quantity_of_articles-1)
    # print(random_number)
    my_dictionary['response']['results'][random_number]['views'] += 1
    print(my_dictionary)
